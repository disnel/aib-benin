...
<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="{{ path('app_homepage') }}" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <img src="{{ asset('frontend/assets/img/logo_aid.png') }}" style="position:absolute;" alt="">
        {# <h1>Append</h1> #}
        {# <span>.</span> #}
      </a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="index.html#services">Secteur</a></li>
          <li><a href="index.html#portfolio">Nos actions</a></li>
          <li><a href="index.html#contact">Contact</a></li>
          <li><a href="index.html#contact">Devenir membre</a></li>
        </ul>
          ...
          <div class="carousel-item active" style="background-image: url({{ asset('frontend/assets/img/slide/slide-1.jpg') }})">
            <div class="carousel-container">
              <div class="container">
                ...
                <p class="animate__animated animate__fadeInUp">Votre ONG</p>
  ...
  {# <footer id="footer" class="footer">
    ...
    <div class="container copyright text-center mt-4">
      <p>&copy; <span>Copyright</span> <strong class="px-1">Aid-BENIN</strong> <span>Tous droits réservés</span></p>
      <div class="credits">
        Conçu par <a href="#">Disnel</a>
      </div>
    </div>
