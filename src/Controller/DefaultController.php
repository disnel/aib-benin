...
class DefaultController extends AbstractController
{
    ...
    #[Route('/m/{slug}', name: 'app_menus')]
    public function menus(MenuRepository $mr,CoordonneeRepository $cr ,Request $request,SendMailService $mail, $slug = null)
    {
       ...
       switch ($menu->getId()) {
        case '2':
            return $this->render('pages/apropos.html.twig',compact('menu','publications'));
            break;
        case '3':
